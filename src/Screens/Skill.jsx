...
const Skill = () => {
  ...
  const skillFrontEnd = [
    ...
    { name: "Typescript", proficiency: "after:w-[70%] after:from-[#14d9d8] after:to-[#1d3653] after:bg-gradient-to-r" },
  ...
  const skillBackEnd = [
    ...
    { name: "DJango", proficiency: "after:w-[35%] after:from-[#14d9d8] after:to-[#1d3653] after:bg-gradient-to-r" },
        ...
        <div className="flex flex-col md:flex-row h-full items-center px-14 md:pb-0 pb-20">
          <div className="w-full md:w-1/2 md:px-6 relative pt-5">
            <h1 className="text-[#14d9d8] text-[45px] md:text-[70px] leading-[75px] flex font-semibold">
              {["M","y","S", "k", "i", "l", "l", "s"].map((letter,index) => (
                <Bouncingword
                  text={letter}
                  key={index}
                  textClass={`drop-shadow-[1px_1px_50px_rgba(20,217,216,0.5)] select-none cursor-pointer flex ${
                    letter === "S" && "ml-4"
                  }`}
                  onMouseEnter={(e) => {
                    textBounce(e);
            ...
            I create successful responsive websites that are fast, easy to
              ...
              is HTML, CSS, Javascript, ReactJs and NodeJs .
            </p>
            <p className="text-slate-50 my-4 text-justify">
              I also have Competitive programming experience with popular programming languages like ( JavaScript,Python  ).
            </p>
            <p className="text-slate-50 my-4 text-justify flex">
              Visit my social media profile for more details &#160;  
